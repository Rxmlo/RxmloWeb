      ...
      <img width="400" src="/img/bck4.png" />
            ...
            <a href="https://discord.gg/vencode">
                        <div className="flex-1 gap-x-4 flex items-center bg-gradient-to-b from-neutral-900/80 to-neutral-900/20 p-3 rounded-full">
                            <img className="rounded-full h-32 w-32" src="https://media.discordapp.net/attachments/1274439590832246804/1287020544197267529/Rxmlo-Logo.png?ex=66f006c9&is=66eeb549&hm=607a86eacfa5de5ad2cf96c75c80e0f90c3c34a17dd42fdbbbbda5d8150dc9fa&=&format=webp&quality=lossless" />
                            <div>
